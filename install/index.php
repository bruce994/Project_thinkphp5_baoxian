...
define('SOFT_NAME', '懒人微信投票管理系统'.SOFT_VERSION);
...
'license'=>'<div class="license"><h1>懒人微信投票报名管理系统使用协议</h1>

                <p>版权所有 (c)2014-2015 保留所有权利。 </p>

				<p>本系统特色功能如下：</p>

				<p>1、两个接口,互不干扰  支持原有平台接入,同时支持被第三方平台接入</p>

				<p>2、投票活动的图文回复、自定义关键字应答、起止结束日期、投票简介、背景音乐。  </p>

				<p>3、独创防刷票：通过微信号来判断，即使取消关注了，在关注投票也无效。 </p>

				<p>4、关注后投票,快速涌入大量粉丝 自动检测是否关注、提示关注并设置一键关注向导。 </p>

				<p>5、极致投票页面：缩略图瀑布流、滑动加载.提升浏览速度,节省数据流量。 </p>

				<p>6、灵活的广告投放：自有品牌展示,赞助商展示,后续活动提示，均可在活动幻灯片呈现。</p>

				<p>7、一个页面,呈现所有 One&All 分享哪个页面,都呈现所有.减少返回操作,将活动曝光率提升到最大。</p>

				<p>8、在线传图报名,是否开启审核,审核后一键直达投票,智能高效。</p>
...
'title_install' => '懒人微信投票报名管理系统'.SOFT_VERSION.' 安装程序',
...
$dirfile_items = array(
    ...
    'conf' => array('type' => 'file', 'path' => './mysqlconf.php'),
...
if($method == 'show_license') {//声明
	...
	if($submit) {
		...
		if($confstatus['status']==1){
			...
			$db->query("delete from `{$tablepre}administrator` ");
			...
			$db->query("INSERT INTO `{$tablepre}administrator` (`a_id`, `admin_name`, `password`, `login_time`) VALUES

(1, '".$username."', '".$password."', '".time()."')");
...
<meta content="懒人微信投票报名管理系统" name="Copyright" />

<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"/var/www/html/www/whyaojin.cn/application/member/view/article_randomPic_edit.html";i:1507608922;s:63:"/var/www/html/www/whyaojin.cn/application/member/view/head.html";i:1507608923;s:65:"/var/www/html/www/whyaojin.cn/application/member/view/footer.html";i:1507608922;}*/ ?>
              ...
              <div class="box box-primary">
                ...
                <form role="form" method="post" id="form1" action="<?php echo $url; ?>" class="pageForm required-validate">
                  <div class="box-body">
                      ...
                      <label>图片：</label>
                      <div class="input-group">
                          <input type="text" id="picurl" name="picurl" class="form-control required" value="<?php echo $vo['picurl']; ?>">

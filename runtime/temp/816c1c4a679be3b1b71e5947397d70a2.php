              ...
              <div class="box box-primary">
                ...
                <form role="form" method="post" id="form1" action="<?php echo $url; ?>" class="pageForm required-validate">
                  <div class="box-body">
                      ...
                      <div class="form-group">
                          <label>排序：</label>
                          <input type="text" name="sort" value="<?php echo $vo['sort']; ?>"  class="form-control number"  >
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <select name="template" class="form-control select2">
                              ...
                              foreach($list as $f){
                              ?>
                              <option value="<?php echo $f['id']; ?>"  <?php if($vo['template'] == $f['id']){  ?>selected <?php } ?> ><?php echo $f['title']; ?></option>
                              <?php } ?>
                          </select>
                      </div>

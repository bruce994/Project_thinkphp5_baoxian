<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"/var/www/html/www/whyaojin.cn/application/member/view/index_diymenu_edit.html";i:1507608923;s:63:"/var/www/html/www/whyaojin.cn/application/member/view/head.html";i:1507608923;s:65:"/var/www/html/www/whyaojin.cn/application/member/view/footer.html";i:1507608922;}*/ ?>
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                ...
                <form role="form" method="post" id="form1" action="<?php echo $url; ?>" class="pageForm required-validate">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <select name="typeid" onchange="change(this.value);" class="form-control">
                                <option value="0" <?php if($vo['typeid'] == '0'): ?>selected<?php endif; ?> >关键词回复菜单</option>
                                <option value="1" <?php if($vo['typeid'] == '1'): ?>selected<?php endif; ?> >url链接菜单</option>
                            </select>         
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="pid" class="form-control"> 
                                ...
                                <?php if(is_array($pp) || $pp instanceof \think\Collection || $pp instanceof \think\Paginator): $i = 0; $__LIST__ = $pp;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pp): $mod = ($i % 2 );++$i;?>
                                <option value="<?php echo $pp['id']; ?>" <?php if($pp['id'] == $vo['pid']){ ?> selected <?php } ?>  ><?php echo $pp['title']; ?></option>
                    ...
                    <div class="form-group">
                        <label>排序：</label>
                        <input type="text" name="sort"  class="form-control number"  value="<?php echo $vo['sort']; ?>">
                    </div>

<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"/var/www/html/www/whyaojin.cn/application/member/view/poster_index.html";i:1507737465;s:63:"/var/www/html/www/whyaojin.cn/application/member/view/head.html";i:1507608923;s:65:"/var/www/html/www/whyaojin.cn/application/member/view/footer.html";i:1507608922;}*/ ?>
              ...
              <div class="box">
                  <div class="box-header">
                      <div style="float:left;margin:0 8px;">
                        <a href="<?php echo url("poster/index",array("act"=>"add","ss"=>11)); ?>" class="btn btn-block btn-default btn-sm"><i class="fa fa-fw fa-plus"></i>添加</a>
                      </div>
                ...
                <div class="box-body">
                  ...
                  <table id="example2" class="table table-bordered table-hover">
                      ...
                      <tr>
                          ...
                          <td>
                              <?php echo $vo['keyword']; ?></td>
                          <td>
                              <p>
                              <a class="btn btn-primary btn-xs" data-toggle="modal" data-target="#myModal<?php echo $vo['id']; ?>" >扫描二维码预览</a>
                              </p>
                              <?php
                          ...
                          <td><?php echo date("Y-m-d",$vo['statdate']); ?></td>
                          ...
                          <td>
                         <a title="编辑" href="<?php echo url("poster/index",array("id"=>$vo['id'],"act"=>"edit","ss"=>11)); ?>"><i class="fa fa-fw fa-edit"></i></a> |
                         <a  href="javascript:void(0);" data-toggle="modal" data-target="#lc_confirm" onclick="lr_confirm('确定删除？','<?php echo url("poster/index",array("act"=>"del","id"=>$vo['id'],"ss"=>11)); ?>');"><i class="fa fa-fw fa-remove"></i></a>
                      </td>
                      </tr>

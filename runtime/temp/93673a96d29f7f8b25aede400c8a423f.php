<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"/var/www/html/www/whyaojin.cn/application/admin/view/index_template_edit.html";i:1507610121;s:62:"/var/www/html/www/whyaojin.cn/application/admin/view/head.html";i:1507610120;s:64:"/var/www/html/www/whyaojin.cn/application/admin/view/footer.html";i:1507610120;}*/ ?>
              ...
              <div class="box box-primary">
                ...
                <form role="form" method="post" id="form1" action="<?php echo $url; ?>" class="pageForm required-validate">
                  <div class="box-body">
                      ...
                      <div class="form-group">
                          <label>所在文件夹：</label>
                          <input type="text" name="folder" value="<?php echo $vo['folder']; ?>"  class="form-control required"  >
                      </div>

                      <div class="form-group">
                      <label>缩略图：</label>
                      <div class="input-group">
                          <input type="text" id="picurlg" name="picurl" class="form-control required" value="<?php echo $vo['picurl']; ?>">
                          <span class="input-group-addon"><a href="javascript:void();" onclick="upyunWapPicUpload('picurlg')"><i class="fa fa-fw fa-upload"></i>点击上传</a></span>
                          <span class="input-group-addon"><a href="javascript:void();" onclick="viewImg('picurlg')"><i class="fa fa-fw fa-share"></i>预览</a></span>
                      </div>
                  </div>  
                      ...
                      <div class="form-group">
                          ...
                          <select name="typeid" class="form-control select2">
                              ...
                              ?>
                              <option value="<?php echo $f['id']; ?>"  <?php if($vo['typeid'] == $f['id']){  ?>selected <?php } ?> ><?php echo $f['title']; ?></option>
                              <?php } ?>

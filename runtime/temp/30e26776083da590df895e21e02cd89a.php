<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"/var/www/html/www/whyaojin.cn/application/admin/view/index_admin.html";i:1507610120;s:62:"/var/www/html/www/whyaojin.cn/application/admin/view/head.html";i:1507610120;s:64:"/var/www/html/www/whyaojin.cn/application/admin/view/footer.html";i:1507610120;}*/ ?>
              ...
              <div class="box">
                ...
                <div class="box-header">
                    <div style="float:left;margin:0 8px;">
                      <a href="<?php echo url("Index/admin",array("act"=>"add","ss"=>1)); ?>" class="btn btn-block btn-default btn-sm"><i class="fa fa-fw fa-plus"></i>添加</a>
                    </div>
                  ...
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                      <tr>
                        ...
                        <td>
                          <a  href="javascript:void(0);" data-toggle="modal" data-target="#lc_confirm" onclick="lr_confirm('确定删除？','<?php echo url("Index/admin",array("act"=>"del","id"=>$vo['id'])); ?>');"><i class="fa fa-fw fa-remove"></i></a>
                        </td>
                      </tr>

<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"/var/www/html/www/whyaojin.cn/application/member/view/index_ad.html";i:1507608923;s:63:"/var/www/html/www/whyaojin.cn/application/member/view/head.html";i:1507608923;s:65:"/var/www/html/www/whyaojin.cn/application/member/view/footer.html";i:1507608922;}*/ ?>
              ...
              <div class="box">
                  <div class="box-header">
                        <div style="float:left;margin:0 8px;">
                          <a href="<?php echo url("index/ad",array("act"=>"add","ss"=>12)); ?>" class="btn btn-block btn-default btn-sm"><i class="fa fa-fw fa-plus"></i>添加</a>
                      </div>
                ...
                <div class="box-body">
                  ...
                  <table id="example2" class="table table-bordered table-hover">
                      ...
                      <tr>
                          ...
                          <td data-title="广告标题"><?php echo $vo['title']; ?></td>
                          <td data-title="广告图片"><img  src="<?php echo $vo['picurl']; ?>" width="100px"  height="30px"></td>
                          <td data-title="是否展示">
                              <?php if($vo['display'] == '0'): ?>
                              <span class="badge bg-red">关闭</span>
                              <?php endif; if($vo['display'] == '1'): ?>
                              <span class="badge bg-light-blue">启用</span>
                              <?php endif; ?>
                          </td>
                          <td data-title="添加时间"><?php echo date("Y-m-d H:i:s",$vo['addtime']); ?></td>
                          <td  data-title="操作">
                              <a title="编辑" href="<?php echo url("index/ad",array("id"=>$vo['id'],"act"=>"edit","ss"=>12)); ?>"><i class="fa fa-fw fa-edit"></i></a> |
                              <a  href="javascript:void(0);" data-toggle="modal" data-target="#lc_confirm" onclick="lr_confirm('确定删除？','<?php echo url("index/ad",array("act"=>"del","id"=>$vo['id'],"ss"=>11)); ?>');"><i class="fa fa-fw fa-remove"></i></a>
                          </td>
                      </tr>

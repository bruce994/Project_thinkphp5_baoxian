<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"/var/www/html/www/whyaojin.cn/application/member/view/article_index.html";i:1507608921;s:63:"/var/www/html/www/whyaojin.cn/application/member/view/head.html";i:1507608923;s:65:"/var/www/html/www/whyaojin.cn/application/member/view/footer.html";i:1507608922;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
    <meta charset="utf-8">
            ...
            <div class="col-md-12">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">资讯链接： <?php echo config("config.ss_site_domain"); ?><?php echo trim(url("index/article/index",["mid"=>$mid]),'/'); ?> </h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                ...
                <div class="form-group">
                    <label>微信描述：</label>
                    <input type="text" name="wx_info"  class="form-control"  value="<?php echo $vo['wx_info']; ?>">
                </div>
                  ...
                  <div class="form-group">
                      <label>微信弹出图片：</label>
                      <div class="input-group">
                          <input type="text" id="wx_picurl" name="wx_picurl" class="form-control required" value="<?php echo $vo['wx_picurl']; ?>">

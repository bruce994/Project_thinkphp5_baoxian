<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"/var/www/html/www/whyaojin.cn/application/index/view/member_1.html";i:1507908102;}*/ ?>
...
link: '<?php echo trim(config('config.ss_site_domain'),'/'); ?><?php echo url("member/index",["mid"=>input("mid"),"id"=>input("id"),"openid"=>$user['wecha_id']]); ?>',

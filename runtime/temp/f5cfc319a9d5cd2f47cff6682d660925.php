<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"/var/www/html/www/whyaojin.cn/application/member/view/index_ad_edit.html";i:1507608923;s:63:"/var/www/html/www/whyaojin.cn/application/member/view/head.html";i:1507608923;s:65:"/var/www/html/www/whyaojin.cn/application/member/view/footer.html";i:1507608922;}*/ ?>
              ...
              <div class="box box-primary">
                ...
                <form role="form" method="post" id="form1" action="<?php echo $url; ?>" class="pageForm required-validate">
                    <div class="box-body">
                      ...
                      <?php if(input("act") == "add"): ?>
                      <div class="form-group">
                          <label>类型：</label>
                          <select name="featuresId" class="form-control select2" onchange='location.href="/index.php/member/index/ad/act/<?php echo input('act'); ?>/ss/<?php echo input('ss'); ?>/featuresId/"+this.value'>
                            <?php if(is_array($features) || $features instanceof \think\Collection || $features instanceof \think\Paginator): $i = 0; $__LIST__ = $features;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$f): $mod = ($i % 2 );++$i;?>
                                <option value="<?php echo $f['id']; ?>" <?php if($vo['featuresId'] == $f['id'] or input('featuresId') == $f['id']): ?>selected <?php endif; ?>  ><?php echo $f['title']; ?></option>
                      ...
                      <?php endif; ?>
                        ...
                        <div class="form-group">
                            ...
                            <select name="vid" class="form-control select2 required number">
                                <?php if(is_array($vlist) || $vlist instanceof \think\Collection || $vlist instanceof \think\Paginator): $i = 0; $__LIST__ = $vlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                                <option value="<?php echo $v['id']; ?>" <?php if($vo['vid'] == $v['id']): ?>selected <?php endif; ?>  ><?php echo $v['title']; ?></option>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            <label>广告标题：</label>
                            <input type="text" name="title"  class="form-control"  value="<?php echo $vo['title']; ?>">
                        </div>
                        <div class="form-group">
                            <label>广告链接：</label>
                        ...
                        <div class="form-group">
                            <label>是否显示：</label>
                            不显示　<input type="radio" id="auth" value = '0' name="display" <?php if($vo['display'] == 0): ?>checked<?php endif; ?>>&nbsp;&nbsp;&nbsp;显示 <input type="radio" id="auth2" value = "1" name="display" <?php if($vo['display'] == 1): ?>checked<?php endif; ?>>
                        </div>                  
                    </div><!-- /.box-body --> 

<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"/var/www/html/www/whyaojin.cn/application/member/view/index_setting.html";i:1507608924;s:63:"/var/www/html/www/whyaojin.cn/application/member/view/head.html";i:1507608923;s:65:"/var/www/html/www/whyaojin.cn/application/member/view/footer.html";i:1507608922;}*/ ?>
<!DOCTYPE html>
<html>
  <head>
    <meta charset="utf-8">
              ...
              <div class="box box-primary">
                ...
                <div class="box-body">
                  ...
                  <div class="form-group">
                      <label>头像：</label>
                      <div class="input-group">
                          <input type="text" id="avatar" name="avatar" class="form-control required" value="<?php echo cookie(config('config.ss_auth_key'))['avatar']; ?>">

<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"/var/www/html/www/whyaojin.cn/application/admin/view/member_index_edit.html";i:1507610122;s:62:"/var/www/html/www/whyaojin.cn/application/admin/view/head.html";i:1507610120;s:64:"/var/www/html/www/whyaojin.cn/application/admin/view/footer.html";i:1507610120;}*/ ?>
                ...
                <form role="form" method="post" id="form1" action="<?php echo $url; ?>" class="pageForm required-validate">
                  <div class="box-body">
                      <div class="form-group">
                          <label>用户名:</label>
                          <input type="text" name="m_username" value="<?php echo $vo['m_username']; ?>"  class="form-control required" <?php if(\think\Request::instance()->param('act') == 'edit'): ?> disabled <?php endif; ?>  > 
                      </div>

                      <div class="form-group">
                          <label>密码：</label><small>(不填表示不修改)
                          </small>
                          <input type="text"  type="password" name="m_password" class="form-control">                       </div>

                      <div class="form-group">
                          <label>手机号:</label>
                          <input type="text" name="m_tel" value="<?php echo $vo['m_tel']; ?>"  class="form-control number">
                      </div>
                ...
                <!-- Date range -->
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control pull-right required" id="m_startdate" name="m_startdate" value="<?php echo $vo['m_startdate']; ?>" >
                    </div><!-- /.input group -->
                  </div><!-- /.form group -->
                ...
                <!-- Date range -->
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control pull-right required" id="m_enddate" name="m_enddate" value="<?php echo $vo['m_enddate']; ?>" >
                    </div><!-- /.input group -->
                  </div><!-- /.form group -->
                      ...
                      <div class="form-group">
                          <label>版权:</label>
                          <input type="text" name="m_copyright" value="<?php echo $vo['m_copyright']; ?>"  class="form-control">
                      </div>

                      <div class="form-group">
                          <label>公众号原始id:</label>
                          <input type="text" name="m_wxid" value="<?php echo $vo['m_wxid']; ?>"  class="form-control">
                      </div>

                      <div class="form-group">
                          <label>微信号:</label>
                          <input type="text" name="m_weixin" value="<?php echo $vo['m_weixin']; ?>"  class="form-control">
                      </div>

                      <div class="form-group">
                          <label>AppID（公众号）:</label>
                          <input type="text" name="m_appid" value="<?php echo $vo['m_appid']; ?>" class="form-control">
                      </div>


                      <div class="form-group">
                          <label>AppSecret:</label>
                          <input type="text" name="m_appsecret" value="<?php echo $vo['m_appsecret']; ?>" class="form-control">
                      </div>

                      <div class="form-group">
                          <label>AesEncodingKey:</label>
                          <input type="text" name="m_aeskey" value="<?php echo $vo['m_aeskey']; ?>" class="form-control">
                      </div>
                      ...
                      <div class="form-group">
                          <label>状态：</label>
                          <br/>
                          <label>启用　<input type="radio" id="auth" value = '1' name="m_status" <?php if($vo['m_status'] == 1): ?>checked<?php endif; ?> > &nbsp;&nbsp;
                          </label>
                          <label>
                            关闭　<input type="radio" id="auth2" value = "0" name="m_status" <?php if($vo['m_status'] == 0): ?>checked<?php endif; ?> >
                          </label>
                      </div>


                      <div class="form-group"><div class="row"><div class="col-lg-12"><label>模块选择:</label></div>
                     <?php
                    $m_auth = explode(",",$vo['m_auth']);
                    foreach($features as $f){
                            ...
                            if(empty($vo['m_auth'])){
                                ...
                                foreach($m_auth as $m){
                                    if($m == $f['id'])  $tmp = "checked";

                                } 
                            }
                    ?>
                              <div class="col-lg-2"><?php echo $f['title']; ?>:<input type="checkbox" name="m_auth[]" value="<?php echo $f['id']; ?>" <?php echo $tmp; ?>></div>
                     <?php } ?> 
                      </div>
                      </div>
  ...
  <link rel="stylesheet" href="<?php echo config("config.ss_web_root"); ?>/plugins/daterangepicker/daterangepicker-bs3.css">
    <script>
      $(function () {
        ...
        $('#m_startdate').daterangepicker({singleDatePicker: true, timePickerIncrement: 1,timePicker: true,timePicker12Hour:false, format: 'YYYY-MM-DD HH:mm'});
        $('#m_enddate').daterangepicker({singleDatePicker: true, timePickerIncrement: 1,timePicker: true,timePicker12Hour:false, format: 'YYYY-MM-DD HH:mm'});
      });
    </script>

<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"/var/www/html/www/whyaojin.cn/application/member/view/index_weixin.html";i:1507608925;s:63:"/var/www/html/www/whyaojin.cn/application/member/view/head.html";i:1507608923;s:65:"/var/www/html/www/whyaojin.cn/application/member/view/footer.html";i:1507608922;}*/ ?>
                ...
                <form role="form" method="post" id="form1" action="<?php echo $url; ?>" class="pageForm required-validate">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            <label>公众号名称：</label>
                            <input type="text" name="m_wxname"  class="form-control required"  value="<?php echo $vo['m_wxname']; ?>">
                        </div>


                        <div class="form-group">
                            <label>微信号：</label>
                            <input type="text" name="m_weixin"  class="form-control required"  value="<?php echo $vo['m_weixin']; ?>">
                        </div>


                        <div class="form-group">
                            <label>公众号原始ID：</label>
                            <input type="text" name="m_wxid"  class="form-control required"  value="<?php echo $vo['m_wxid']; ?>">
                        </div>


                        <div class="form-group">
                            <label>AppID（公众号）：</label>
                            <input type="text" name="m_appid"  class="form-control required"  value="<?php echo $vo['m_appid']; ?>">
                        </div>


                        <div class="form-group">
                            <label>AppSecret：</label>
                            <input type="text" name="m_appsecret"  class="form-control required"  value="<?php echo $vo['m_appsecret']; ?>">
                        </div>


                        <div class="form-group">
                            <label>EncodingAESKey(消息加解密密钥)：</label><small>微信公众号登陆授权不需要填写</small>

                            <input type="text" name="m_aeskey"  class="form-control"  value="<?php echo $vo['m_aeskey']; ?>">
                        </div>


                        <div class="form-group"><label>上传微信JS安全域名认证文件</label><small>(上传认证后便于微信分享正常、微信支付等功能)</small>
                            <div class="input-group">
                                <input type="text" id="m_jsPath" name="m_jsPath" value="<?php echo $vo['m_jsPath']; ?>" class="form-control" value=""><span class="input-group-addon"><a href="javascript:void();" onclick="upyunWapPicUpload('m_jsPath','','','','jsPath')"><i class="fa fa-fw fa-upload"></i>点击上传</a></span></div>
                        </div>



                        <div class="form-group">
                            <label>是否开启关注微信公众号：</label>


                            是　<input type="radio" id="m_isConnent" value = '1' name="m_isConnent" <?php if($vo['m_isConnent'] == 1): ?>checked<?php endif; ?>>&nbsp;&nbsp;&nbsp;否　<input type="radio" id="m_isConnent2" value = "0" name="m_isConnent" <?php if($vo['m_isConnent'] == 0): ?>checked<?php endif; ?> >           
                        ...
                        <div class="form-group">
                            <label>是否需要网页授权判断关注微信：</label>                    

                            是　<input type="radio" id="m_web_auth" value = '1' name="m_web_auth" <?php if($vo['m_web_auth'] == 1): ?>checked<?php endif; ?> >&nbsp;&nbsp;&nbsp;否　<input type="radio" id="m_web_auth2" value = "0" name="m_web_auth" <?php if($vo['m_web_auth'] == 0): ?>checked<?php endif; ?>  > 
                            (如：微盟等第三方公众平台，不支持微信标准第三方接口时，可选“是”)
                            <br/>(注意：此项功能需要进入微信公众平台设置“网页授权获取用户基本信息”绑定域名,填写vote.lanrenmb.com)     

                        </div> 


                        <div class="form-group">
                            <label><font color="red">温馨提示：打开微信公众号平台-公众号设置-功能设置-js域名绑定  填写绑定 <?php echo config("config.ss_site_domain"); ?>index.php/index/Weixin/index/token/<?php echo $vo['m_wxid']; ?>.html</font></label>                    

                            <br/><font color="red">(注意：此项功能在微信分享时候起重大作用，一定要填写噢；)  </font>   

<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:76:"/var/www/html/www/whyaojin.cn/application/member/view/article_randomPic.html";i:1507608922;s:63:"/var/www/html/www/whyaojin.cn/application/member/view/head.html";i:1507608923;s:65:"/var/www/html/www/whyaojin.cn/application/member/view/footer.html";i:1507608922;}*/ ?>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            <li><a href="<?php echo url("Index/type"); ?>"><i class="fa fa-dashboard"></i> 首页</a></li>
              ...
              <div class="box">
                  <div class="box-header">
                      <div style="float:left;margin:0 8px;">
                        <a href="<?php echo url("article/randomPic",array("act"=>"add","ss"=>1)); ?>" class="btn btn-block btn-default btn-sm"><i class="fa fa-fw fa-plus"></i>添加</a>
                      </div>
                ...
                <div class="box-body">
                  ...
                  <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                          <tr>
                              ...
                              <td data-title="图片"><img src="<?php echo $vo['picurl']; ?>" width="200" height="80" ></td>
                              <td data-title="操作">
                         <a title="编辑" href="<?php echo url("article/randomPic",array("id"=>$vo['id'],"act"=>"edit","ss"=>1)); ?>"><i class="fa fa-fw fa-edit"></i></a> |
                         <a  href="javascript:void(0);" data-toggle="modal" data-target="#lc_confirm" onclick="lr_confirm('确定删除？','<?php echo url("article/randomPic",array("act"=>"del","id"=>$vo['id'],"ss"=>1)); ?>');"><i class="fa fa-fw fa-remove"></i></a>
                      </td>
                          </tr>

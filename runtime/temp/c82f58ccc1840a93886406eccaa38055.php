<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"/var/www/html/www/whyaojin.cn/application/admin/view/member_index.html";i:1507610121;s:62:"/var/www/html/www/whyaojin.cn/application/admin/view/head.html";i:1507610120;s:64:"/var/www/html/www/whyaojin.cn/application/admin/view/footer.html";i:1507610120;}*/ ?>
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                  ...
                  <form action="<?php echo url("member/member",array("ss"=>2)); ?>" method="post">
                      <div class="box-header">
                          <div style="float:left;margin:0 8px;">
                              <a href="<?php echo url("member/member",array("act"=>"add","ss"=>2)); ?>" class="btn btn-block btn-default btn-sm"><i class="fa fa-fw fa-plus"></i>添加</a>
                          </div>
                          ...
                          <div class="box-tools">
                              <div class="input-group" style="width: 150px;">
                                  <input type="text" name="m_username" class="form-control input-sm pull-right" placeholder="按登陆名搜索" value="<?php echo \think\Request::instance()->get('m_username'); ?>">
                ...
                <div class="box-body">
                  ...
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tr>
                      <td data-title="选择">
                          <input name="id" value="<?php echo $vo['m_id']; ?>" type="checkbox" onclick="addids(this)"></td>
                      <td data-title="用户登陆名"><a href="<?php echo url("member/base/directLogin",['mid'=>$vo['m_id'],'pwd'=>$vo['m_password']]); ?>" target="_blank"><?php echo $vo['m_username']; ?></a></td>
                      <td data-title="最后登陆IP"><?php echo $vo['m_ip']; ?></td>
                      <td data-title="登陆时间"><?php echo date("Y-m-d H:i:s",$vo['m_addtime']); ?></td>
                      <td data-title="开始时间"><?php echo $vo['m_startdate']; ?></td>
                      <td data-title="结束时间"><?php echo $vo['m_enddate']; ?></td>
                      <td data-title="能添加投票数目"><?php echo $vo['m_num']; ?></td>
                      <td data-title="公众号名称"><?php echo $vo['m_wxname']; ?></td>
                      
                      <td data-title="状态">
                             <?php if($vo['m_status'] == '0'): ?>
                                <span class="label label-danger">关闭</span>
                             <?php endif; if($vo['m_status'] == '1'): ?>
                                <span class="label label-success">启用</span>
                             <?php endif; ?>
                    </td>
                      <td data-title="操作">
                         <a title="编辑" href="<?php echo url("member/member",array("id"=>$vo['m_id'],"act"=>"edit","ss"=>2)); ?>"><i class="fa fa-fw fa-edit"></i></a> |
                        <a  href="javascript:void(0);" data-toggle="modal" data-target="#lc_confirm" onclick="lr_confirm('确定删除？','<?php echo url("member/member",array("act"=>"del","id"=>$vo['m_id'])); ?>');"><i class="fa fa-fw fa-remove"></i></a>
                      </td>
                    </tr>

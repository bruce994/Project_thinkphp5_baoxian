<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"/var/www/html/www/whyaojin.cn/application/member/view/index_reply_edit.html";i:1507608924;s:63:"/var/www/html/www/whyaojin.cn/application/member/view/head.html";i:1507608923;s:65:"/var/www/html/www/whyaojin.cn/application/member/view/footer.html";i:1507608922;}*/ ?>
                ...
                <form role="form" method="post" id="form1" action="<?php echo $url; ?>" class="pageForm required-validate">
                    ...
                    <div class="box-body">
                        <div class="form-group">
                            <label>解发关键词：</label><small> (如果不填，表示没有匹配时或关注时弹出回复) </small>
                            <input type="text" name="keyword"  class="form-control"  value="<?php echo $vo['keyword']; ?>">
                        </div>


                        <div class="form-group">
                            <label>摘要：</label><small> (200字以内) </small>
                            <BR>
                            <textarea name="description" style="width:40%;height:100px;" calss="form-control required" placeholder="在这里输入内容"><?php echo $vo['description']; ?></textarea>
                        </div>


                        <?php
                            if($vo['typeid'] == 2 || request()->param("typeid") == 2 ){
                        ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" value="<?php echo $vo['title']; ?>"  class=" form-control" > 
                        ...
                        <div class="form-group">
                            <label >跳转网址：（如：http://www.lanrenmb.com）</label>

                            <input type="text" name="jumpUrl" value="<?php echo $vo['jumpUrl']; ?>" class="form-control"> 

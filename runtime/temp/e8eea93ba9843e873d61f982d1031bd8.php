<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"/var/www/html/www/whyaojin.cn/application/admin/view/index_template.html";i:1507610121;s:62:"/var/www/html/www/whyaojin.cn/application/admin/view/head.html";i:1507610120;s:64:"/var/www/html/www/whyaojin.cn/application/admin/view/footer.html";i:1507610120;}*/ ?>
              ...
              <div class="box">
                  <div class="box-header">
                      <div style="float:left;margin:0 8px;">
                        <a href="<?php echo url("index/template",array("act"=>"add","ss"=>1)); ?>" class="btn btn-block btn-default btn-sm"><i class="fa fa-fw fa-plus"></i>添加</a>
                      </div>
                ...
                <div class="box-body">
                  ...
                  <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                          <tr>
                              ...
                              <td data-title="所在文件夹"><?php echo $vo['folder']; ?></td>
                              <td data-title="状态">
                                  <?php if($vo['status'] == '0'): ?>
                              ...
                              <td data-title="操作">
                         <a title="编辑" href="<?php echo url("index/template",array("id"=>$vo['id'],"act"=>"edit","ss"=>2)); ?>"><i class="fa fa-fw fa-edit"></i></a> |
                        <a  href="javascript:void(0);" data-toggle="modal" data-target="#lc_confirm" onclick="lr_confirm('确定删除？','<?php echo url("index/template",array("act"=>"del","id"=>$vo['id'])); ?>');"><i class="fa fa-fw fa-remove"></i></a>
                      </td>
                          </tr>

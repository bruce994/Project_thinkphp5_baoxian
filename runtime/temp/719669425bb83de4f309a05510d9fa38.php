<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"/var/www/html/www/whyaojin.cn/application/member/view/poster_form_edit.html";i:1507608925;s:63:"/var/www/html/www/whyaojin.cn/application/member/view/head.html";i:1507608923;s:65:"/var/www/html/www/whyaojin.cn/application/member/view/footer.html";i:1507608922;}*/ ?>
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="pid" class="form-control required">
                                <?php if(is_array($poster) || $poster instanceof \think\Collection || $poster instanceof \think\Paginator): $i = 0; $__LIST__ = $poster;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$poster): $mod = ($i % 2 );++$i;?>
                                <option value="<?php echo $poster['id']; ?>" <?php if(input('pid') == $poster['id']){echo 'selected';} ?> ><?php echo $poster['title']; ?></option>
                        ...
                        <div class="form-group">
                            <label>字段一：</label>
                            <input type="text" name="field_1"  class="form-control"  value="<?php echo $vo['field_1']; ?>">
                        </div>

                        <div class="form-group">
                            <label>字段二：</label>
                            <input type="text" name="field_2"  class="form-control"  value="<?php echo $vo['field_2']; ?>">
                        </div>
                        ...
                        <div class="form-group">
                            <label>生成海报图片</label>
                            <div class="input-group">
                                <input type="text" id="posterUrl" name="posterUrl" class="form-control" value="<?php echo $vo['posterUrl']; ?>">
                                <span class="input-group-addon"><a href="javascript:void();" onclick="upyunWapPicUpload('posterUrl')"><i class="fa fa-fw fa-upload"></i>点击上传</a></span>
                                <span class="input-group-addon"><a href="javascript:void();" onclick="viewImg('posterUrl')"><i class="fa fa-fw fa-share"></i>预览</a></span>
                            </div>
                        </div>  

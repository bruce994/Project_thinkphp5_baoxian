<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"/var/www/html/www/whyaojin.cn/application/admin/view/member_notice.html";i:1507610122;s:62:"/var/www/html/www/whyaojin.cn/application/admin/view/head.html";i:1507610120;s:64:"/var/www/html/www/whyaojin.cn/application/admin/view/footer.html";i:1507610120;}*/ ?>
          ...
          <div class="row">
            <div class="col-xs-12">
              <div class="box">
                  ...
                  <form action="<?php echo url("member/notice",array("ss"=>2)); ?>" method="get">
                      <input type="hidden" name="m" value="member">
                      <input type="hidden" name="a" value="index">
                      <input type="hidden" name="ss" value="2">
                  <div class="box-header">
                      <div style="float:left;margin:0 8px;">
                        <a href="<?php echo url("member/notice",array("act"=>"add","ss"=>2)); ?>" class="btn btn-block btn-default btn-sm"><i class="fa fa-fw fa-plus"></i>添加</a>
                      </div>
                ...
                <div class="box-body">
                  ...
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tr>
                      ...
                      <td data-title="操作">
                         <a title="编辑" href="<?php echo url("member/notice",array("id"=>$vo['id'],"act"=>"edit","ss"=>2)); ?>"><i class="fa fa-fw fa-edit"></i></a> |
                        <a  href="javascript:void(0);" data-toggle="modal" data-target="#lc_confirm" onclick="lr_confirm('确定删除？','<?php echo url("member/notice",array("act"=>"del","id"=>$vo['id'])); ?>');"><i class="fa fa-fw fa-remove"></i></a>
                      </td>
                    </tr>

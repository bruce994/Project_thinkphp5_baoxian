<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"/var/www/html/www/whyaojin.cn/application/member/view/index_fans.html";i:1507608924;s:63:"/var/www/html/www/whyaojin.cn/application/member/view/head.html";i:1507608923;s:65:"/var/www/html/www/whyaojin.cn/application/member/view/footer.html";i:1507608922;}*/ ?>
            ...
            <div class="col-xs-12">
              <div class="box">
                  <div class="box-header">
                      <form action="<?php echo url("index/fans",array("ss"=>12)); ?>" method="get">
                          <div class="form-group">
                              <label>微信昵称</label>
                              <input type="text" name="wechaname" class="form-control" value="<?php echo \think\Request::instance()->get('wechaname'); ?>"> 
                          </div>
                ...
                <div class="box-body">
                  ...
                  <table id="example2" class="table table-bordered table-hover">
                      ...
                      <tr>
                          ...
                          <td data-title="微信昵称">
                              <?php echo $vo['wechaname']; ?>
                          </td>
                          <td data-title="城市"><?php echo $vo['city']; ?></td>
                          <td data-title="省份"><?php echo $vo['province']; ?></td>
                          <td data-title="国家"><?php echo $vo['country']; ?></td>
                          <td data-title="微信头像"><img  src="<?php echo $vo['wechahead']; ?>" width="80px"  height="80px"></td>
                          <td data-title="姓别">
                              <?php if($vo['sex'] == '0'): ?>
                              <span class="badge bg-yellow">未知</span>
                              <?php endif; if($vo['sex'] == '1'): ?>
                              <span class="badge bg-light-blue">男</span>
                              <?php endif; if($vo['sex'] == '2'): ?>
                              <span class="badge bg-red">女</span>
                              <?php endif; ?>
                          </td>
                          <td data-title="关注时间"><?php echo date("Y-m-d H:i:s",$vo['subscribe_time']); ?></td>                            
                      </tr>

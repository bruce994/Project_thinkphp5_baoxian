<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:71:"/var/www/html/www/whyaojin.cn/application/member/view/article_type.html";i:1507711659;s:63:"/var/www/html/www/whyaojin.cn/application/member/view/head.html";i:1507608923;s:65:"/var/www/html/www/whyaojin.cn/application/member/view/footer.html";i:1507608922;}*/ ?>
              ...
              <div class="box">
                  <div class="box-header">
                      <div style="float:left;margin:0 8px;">
                        <a href="<?php echo url("article/type",array("act"=>"add","ss"=>1)); ?>" class="btn btn-block btn-default btn-sm"><i class="fa fa-fw fa-plus"></i>添加</a>
                      </div>
                  ...
                  <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                          <tr>
                              ...
                              <td data-title="是否我的微站固定">
                                  <?php if($vo['isWzShow'] == '1'): ?>
                                  <span class="label label-success">是</span>
                                  <?php endif; if($vo['isWzShow'] == '0'): ?>
                              ...
                              <td data-title="操作">
                         <a title="编辑" href="<?php echo url("article/type",array("id"=>$vo['id'],"act"=>"edit","ss"=>1)); ?>"><i class="fa fa-fw fa-edit"></i></a> |
                         <a  href="javascript:void(0);" data-toggle="modal" data-target="#lc_confirm" onclick="lr_confirm('确定删除？','<?php echo url("article/type",array("act"=>"del","id"=>$vo['id'],"ss"=>1)); ?>');"><i class="fa fa-fw fa-remove"></i></a>
                      </td>
                          </tr>

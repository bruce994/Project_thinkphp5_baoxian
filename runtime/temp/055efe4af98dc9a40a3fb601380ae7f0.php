<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"/var/www/html/www/whyaojin.cn/application/member/view/index_reply.html";i:1507608924;s:63:"/var/www/html/www/whyaojin.cn/application/member/view/head.html";i:1507608923;s:65:"/var/www/html/www/whyaojin.cn/application/member/view/footer.html";i:1507608922;}*/ ?>
              ...
              <div class="box">
                  <div class="box-header">
                      <div style="float:left;margin:0 8px;">
                        <a href="javascript:void(0);" data-toggle="modal" data-target="#myModal"  class="btn btn-block btn-default btn-sm"><i class="fa fa-fw fa-plus"></i>添加</a>
                      </div>
                      <div style="float:left;">
                        <a href="#" id="ids0" class="btn btn-block btn-default btn-sm" onclick="action('act/del/ss/2/id/','ids0');"> <i class="fa fa-fw fa-remove"></i>
                         删 除
                       </a>
                       </div>
                  </div><!-- /.box-header -->
                        ...
                        <div class="modal-dialog modal-sm" role="document">
                          <div class="modal-content">
                            <div class="modal-body" style="text-align:center;">
                                   <form method="get" id="form2" action="<?php echo url("index/reply",array("act"=>"add","ss"=>2)); ?>">
                                      <select name="typeid" class="control-label col-xs-5">
                                        <option value="1">文字类型</option>
                                        <option value="2">图文类型</option>
                                      </select>
                                      <button class="btn btn-small btn-primary btn-sm">下一步</button>
                                </form>
                            </div>
                      ...
                      <table id="example2" class="table table-bordered table-hover">
                          ...
                          <tr>
                              ...
                              <td>
                                  ...
                                  没有关键词
                                  <?php else: ?>
                                  <?php echo $vo['keyword']; endif; ?>
                              </td>
                              <td><?php echo $vo['title']; ?></td>
                              <td>
                                  <?php if($vo['typeid'] == '1'): ?>
                                  <span class="label label-danger">文字类型</span>
                                  <?php endif; if($vo['typeid'] == '2'): ?>
                              ...
                              <td>
                                  <a title="编辑" href="<?php echo url("index/reply",array("act"=>"edit","id"=>$vo['id'],"ss"=>2)); ?>"><i class="fa fa-fw fa-edit"></i></a> | <a href="javascript:void(0);" data-toggle="modal" data-target="#lc_confirm" onclick="lr_confirm('确定删除？','<?php echo url("index/reply",array("act"=>"del","id"=>$vo['id'],"ss"=>2)); ?>');"><i class="fa fa-fw fa-remove"></i></a>
                              </td>

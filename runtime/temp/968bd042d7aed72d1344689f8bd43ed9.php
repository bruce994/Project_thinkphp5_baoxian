<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"/var/www/html/www/whyaojin.cn/application/member/view/index_diymenu.html";i:1507608923;s:63:"/var/www/html/www/whyaojin.cn/application/member/view/head.html";i:1507608923;s:65:"/var/www/html/www/whyaojin.cn/application/member/view/footer.html";i:1507608922;}*/ ?>
              ...
              <div class="box">
                  <div class="box-header">
                      <div style="float:left;margin:0 8px;">
                        <a href="<?php echo url("index/diymenu",array("act"=>"add","ss"=>2)); ?>" class="btn btn-block btn-default btn-sm"><i class="fa fa-fw fa-plus"></i>添加</a>
                      </div>
                ...
                <div class="box-body">
                  ...
                  <table id="example2" class="table table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if($vo['pid'] != '0'): if($vo['typeid'] == '0'): ?>
                                <span class="label label-success">关键词回复菜单</span>
                                <?php endif; if($vo['typeid'] == '1'): ?>
                                <span class="label label-important">url链接菜单</span>
                                <?php endif; endif; if($vo['pid'] == '0'): ?>父级菜单<?php endif; ?>
                        </td>
                        <td>
                            <?php if($vo['pid'] != '0'): if($vo['typeid'] == '0'): ?>
                            <?php echo $vo['keyword']; endif; if($vo['typeid'] == '1'): ?>
                            <?php echo $vo['url']; endif; endif; if($vo['pid'] == '0'): ?>无<?php endif; ?>
                        </td>
                        <td>
                            <a title="编辑" href="<?php echo url("index/diymenu",array("id"=>$vo['id'],"act"=>"edit","ss"=>2)); ?>"><i class="fa fa-fw fa-edit"></i></a> |
                            <a href="javascript:void(0);" data-toggle="modal" data-target="#lc_confirm" onclick="lr_confirm('确定删除？','<?php echo url("index/diymenu",array("id"=>$vo['id'],"act"=>"del","ss"=>2)); ?>');"><i class="fa fa-fw fa-remove"></i></a>
                    ...
                    <tr>
                        ...
                        <td style="text-align:left;">
                            <img src="<?php echo config('config.ss_web_root'); ?>/images/bg_repno.gif" />
                        ...
                        <td  style="word-wrap:break-word;">
                            <?php if($value['typeid'] == 0){ ?>
                            <?php echo $value['keyword']; } if($value['typeid'] == 1){ ?>
                            <?php echo $value['url']; } ?>
                        </td>


                        <td>
                            <a title="编辑" href="<?php echo url("index/diymenu",array("id"=>$value['id'],"act"=>"edit","ss"=>2)); ?>"><i class="fa fa-fw fa-edit"></i></a> |
                            <a href="javascript:void(0);" data-toggle="modal" data-target="#lc_confirm" onclick="lr_confirm('确定删除？','<?php echo url("index/diymenu",array("id"=>$value['id'],"act"=>"del","ss"=>2)); ?>');"><i class="fa fa-fw fa-remove"></i></a>
                        </td>
                ...
                <div class="box-footer">
                    <a href="<?php echo url("index/greatemenu"); ?>" ><button  class="btn btn-primary">生成自定义菜单</button> </a>
